...
class OwnerControllerTest {
    ...
    @Test
    void findByNameReturnOneOwner() throws Exception {
        Owner justOne = new Owner();
        justOne.setId(1);
        justOne.setLastName("Find One");

        given(clinicService.findOwnerByLastName("Find One")).willReturn(Lists.newArrayList(justOne));

        mockMvc.perform(get("/owners")
                .param("lastName", "Find One"))
            .andExpect(status().is3xxRedirection())
    ...
    @Test
    void findByNameReturnListOfOwners() throws Exception {
